...
export TOTAL_TIME_AVAILABLE=20
start-test 40 $EACH_CLIENT_ISSUE $TOTAL_CLIENT $TOTAL_TIME_AVAILABLE ${TESTNAME}-part4 ${CLIENT_TESTNAME} &

export TOTAL_CLIENT=32
export TOTAL_TIME_AVAILABLE=10
start-test 50 $EACH_CLIENT_ISSUE $TOTAL_CLIENT $TOTAL_TIME_AVAILABLE ${TESTNAME}-part5 ${CLIENT_TESTNAME} &
